        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(maxLength: 256, nullable: false),
                    Description = table.Column<string>(maxLength: 10240, nullable: false),
                    Teacher = table.Column<string>(maxLength: 256, nullable: false),
                    LectureRoom = table.Column<string>(maxLength: 256, nullable: false),
                    EventId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationOnDisk = table.Column<string>(maxLength: 512, nullable: false),
                    FtpFileUrl = table.Column<string>(maxLength: 512, nullable: false),
                    Discriminator = table.Column<string>(nullable: false),
